package pri.smilly.component;

import lombok.SneakyThrows;
import org.springframework.stereotype.Component;
import pri.smilly.config.SystemConfiguration;
import pri.smilly.domain.UploadInfo;
import pri.smilly.util.ConverterUtil;
import pri.smilly.util.FileUtil;
...
public class FileCacheComponent {
    ...
    @SneakyThrows
    public void save() {
        write(ConverterUtil.json(cache), cacheFile, false);
    }
    ...
    private List<UploadInfo> read(File file) {
        synchronized (cacheFile) {
            ...
            return ConverterUtil.parserList(json, UploadInfo.class);
        }
    }
}
